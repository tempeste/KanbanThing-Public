...
For workspaces using the OpenClaw dispatch plugin:
...
- Even with hard-kill enabled, enforcement hooks (`subagent_spawning`, `before_tool_call`) are the reliability baseline for preventing further work after cancel.
